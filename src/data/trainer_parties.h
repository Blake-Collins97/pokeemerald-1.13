...
static const struct TrainerMonItemCustomMoves sParty_Johnson[] = { // Route 116
    ...
    .lvl = -4,
    .species = SPECIES_SEEDOT,
    .moves = MOVE_DETECT, MOVE_BIDE, MOVE_LEER, MOVE_HEADBUTT
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Dawson[] = { // Route 116
    ...
    .moves = MOVE_INCINERATE, MOVE_BITE, MOVE_POISON_GAS, MOVE_CLEAR_SMOG
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Roxanne1[] = {
    ...
    .moves = MOVE_ROCK_TOMB, MOVE_FURY_CUTTER, MOVE_BUG_BITE, MOVE_AQUA_JET
    },
    {
    .lvl = -2,
...
static const struct TrainerMonItemCustomMoves sParty_Chandler[] = {
    ...
    .lvl = -1,
    .species = SPECIES_CLAUNCHER,
    .moves = MOVE_SCALD, MOVE_VISE_GRIP, MOVE_DEFENSE_CURL, MOVE_BUBBLE_BEAM
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Rhett[] = {
    ...
    .species = SPECIES_GRAPPLOCT,
    .spread = SPREAD_10_IV_0_EV,
    .moves = MOVE_BRICK_BREAK, MOVE_BULK_UP, MOVE_LOW_SWEEP, MOVE_DARKEST_LARIAT
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Leroy[] = {
    ...
    .species = SPECIES_CLEFABLE,
    .heldItem = ITEM_LEFTOVERS,
    .ability = 2, // Majoc Guard
    .spread = SPREAD_31_IV_ATK_SPEED_ADAMANT,
    .moves = MOVE_MOONBLAST, MOVE_MOONLIGHT, MOVE_FLAMETHROWER, MOVE_CALM_MIND
    },
    {
    .lvl = 0,
...
static const struct TrainerMonItemCustomMoves sParty_Deandre[] = {
    ...
    .ability = 2, // Blaze
    .spread = SPREAD_15_IV_0_EV,
    .moves = MOVE_MYSTICAL_FIRE, MOVE_PSYBEAM, MOVE_SHADOW_BALL, MOVE_CALM_MIND
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Lydia2[] = {
    ...
    .ability = 2, // Dry Skin
    .spread = SPREAD_31_IV_80_EV,    
    .moves = MOVE_FAKE_OUT, MOVE_NASTY_PLOT, MOVE_DAZZLING_GLEAM, MOVE_PSYSHOCK
    },
    {
    .lvl = -5,
...
static const struct TrainerMonItemCustomMoves sParty_Derek[] = {
    ...
    .species = SPECIES_BUTTERFREE,
    .spread = SPREAD_15_IV_0_EV,    
    .moves = MOVE_QUIVER_DANCE, MOVE_SILVER_WIND, MOVE_HIDDEN_POWER, MOVE_AIR_SLASH
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Wattson1[] = {
    ...
    .heldItem = ITEM_ELECTRIC_GEM,
    .spread = SPREAD_WATTSON_SPECIAL,
    .moves = MOVE_LOW_KICK, MOVE_FIRE_PUNCH, MOVE_ICE_PUNCH, MOVE_THUNDER_PUNCH
    },
    {
    .lvl = 2,
...
static const struct TrainerMonItemCustomMoves sParty_Sophie[] = {
    ...
    .species = SPECIES_WHIMSICOTT,
    .spread = SPREAD_25_IV_0_EV,
    .moves = MOVE_DRAINING_KISS, MOVE_MOONBLAST, MOVE_COTTON_GUARD, MOVE_ATTRACT
    },
    {
    .lvl = -3,
    .species = SPECIES_SANDSLASH_ALOLAN,
...
static const struct TrainerMonItemCustomMoves sParty_Bernie1[] = {
    ...
    .species = SPECIES_SALANDIT,
    .spread = SPREAD_25_IV_0_EV,
    .moves = MOVE_FLAME_BURST, MOVE_SLUDGE, MOVE_ATTRACT, MOVE_ENDEAVOR
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Bernie2[] = {
    ...
    .species = SPECIES_SALAZZLE,
    .spread = SPREAD_25_IV_0_EV,
    .moves = MOVE_FLAMETHROWER, MOVE_SLUDGE_BOMB, MOVE_ATTRACT, MOVE_ENDEAVOR
    },
/*     {
    .lvl = -3,
...
static const struct TrainerMonItemCustomMoves sParty_Flannery1[] = {
    ...
    .ability = 0, // Corrosion
    .spread = SPREAD_31_IV_HP_SPEED_TIMID,
    .moves = MOVE_FLAMETHROWER, MOVE_SLUDGE_BOMB, MOVE_ENDEAVOR, MOVE_TOXIC
    },
    {
    .lvl = -1,
    .species = SPECIES_PYROAR,
    .heldItem = ITEM_LIFE_ORB,
    .ability = 1, // Competative
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_HYPER_VOICE, MOVE_SNARL, MOVE_FLAMETHROWER, MOVE_QUICK_ATTACK
    },
    {
    .lvl = 0,
    .species = SPECIES_BLAZIKEN,
...
static const struct TrainerMonItemCustomMoves sParty_Norman1[] = {
    ...
    .ability = 0, // Truant
    .spread = SPREAD_31_IV_ATK_SPEED_ADAMANT,
    .moves = MOVE_GIGA_IMPACT, MOVE_DRAIN_PUNCH, MOVE_NIGHT_SLASH, MOVE_BODY_SLAM
    },
    {
    .lvl = 0,
    ...
    .ability = 1, // Iron Fist
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_SKILL_SWAP, MOVE_SHADOW_PUNCH, MOVE_SHADOW_SNEAK, MOVE_DRAIN_PUNCH
    },
    {
    .lvl = 0,
    .species = SPECIES_GOLEM,
    ...
    .ability = 0, // Rock Head
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_HEAD_SMASH, MOVE_HIGH_HORSEPOWER, MOVE_ROCK_SLIDE, MOVE_HAMMER_ARM
    },
    {
    .lvl = 0,
    .species = SPECIES_MACHAMP,
    ...
    .ability = 1, // No Guard
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_DYNAMIC_PUNCH, MOVE_MACH_PUNCH, MOVE_THUNDER_PUNCH, MOVE_ICE_PUNCH
    },
    {
    .lvl = -1,
    .species = SPECIES_MUK,
    ...
    .ability = 2, // Poison Touch
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_POISON_JAB, MOVE_KNOCK_OFF, MOVE_BODY_SLAM, MOVE_GUNK_SHOT
    },
    {
    .lvl = 1,
    .species = SPECIES_SNORLAX,
    ...
    .ability = 1, // Thick Fat
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_FACADE, MOVE_REST, MOVE_SLEEP_TALK, MOVE_CRUNCH
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Luis[] = {
    ...
    .species = SPECIES_WHIMSICOTT,
    .spread = SPREAD_25_IV_0_EV,
    .moves = MOVE_DRAINING_KISS, MOVE_MOONBLAST, MOVE_COTTON_GUARD, MOVE_FAKE_TEARS
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Riley[] = {
    ...
    .lvl = -2,
    .species = SPECIES_FROSMOTH,
    .ability = 2, // Frost scales
    .spread = SPREAD_31_IV_80_EV,
    .moves = MOVE_BUG_BUZZ, MOVE_AIR_SLASH, MOVE_QUIVER_DANCE, MOVE_ICY_WIND
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Winona1[] = {
{
    ...
    .species = SPECIES_DRAGONITE,
    .heldItem = ITEM_LIFE_ORB,
    .ability = 1, // Multiscale
    .spread = SPREAD_31_IV_HP_ATK_MIXED,
    .moves = MOVE_DRAGON_CLAW, MOVE_EXTREME_SPEED, MOVE_DRAGON_DANCE, MOVE_HYPER_BEAM
    },
    {
    .lvl = 1,
    .species = SPECIES_SCEPTILE,
    ...
    .ability = 0, // Overgrow
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_LEAF_STORM, MOVE_DRAGON_PULSE, MOVE_FOCUS_BLAST, MOVE_ENERGY_BALL
    },
    {
    .lvl = 1,
    .species = SPECIES_SCYTHER,
    ...
    .ability = 1, // Unburden
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_ACROBATICS, MOVE_X_SCISSOR, MOVE_DUAL_WINGBEAT, MOVE_KNOCK_OFF
    },
    {
    .lvl = 2,
...
static const struct TrainerMonItemCustomMoves sParty_Winona2[] = { // singles
    ...
    .ability = 0, // levitate
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_PLAY_ROUGH, MOVE_EARTHQUAKE, MOVE_ROOST, MOVE_DRAGON_DANCE
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Winona3[] = { // Doubles
{
    ...
    .ability = 0, // Levitate
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_DAZZLING_GLEAM, MOVE_FIRE_BLAST, MOVE_ROOST, MOVE_ICE_BEAM
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Cale[] = {
    ...
    .ability = 1, // Tinted Lens 
    .spread = SPREAD_31_IV_80_EV,
    .moves = MOVE_QUIVER_DANCE, MOVE_BUG_BUZZ, MOVE_FLASH_CANNON, MOVE_SLUDGE_BOMB
    },
    {
    .lvl = -3,
    .species = SPECIES_FROSMOTH,
    .ability = 2, // Ice Scales
    .spread = SPREAD_31_IV_80_EV,
    .moves = MOVE_QUIVER_DANCE, MOVE_BUG_BUZZ, MOVE_ICE_BEAM, MOVE_PSYCHIC
    },
    {
    .lvl = -3,
    .species = SPECIES_BUTTERFREE,
...
static const struct TrainerMonItemCustomMoves sParty_Mark[] = { // with Leah
    ...
    .species = SPECIES_SWALOT,
    .spread = SPREAD_31_IV_80_EV,
    .moves = MOVE_BODY_SLAM, MOVE_SLUDGE_BOMB, MOVE_FIRE_BLAST, MOVE_THUNDER
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_KimAndIris[] = {
    ...
    .species = SPECIES_WALREIN,
    .spread = SPREAD_31_IV_80_EV,
    .moves = MOVE_ICE_FANG, MOVE_BODY_SLAM, MOVE_LIQUIDATION, MOVE_HAIL
    },
    {
    .lvl = -2,
    .species = SPECIES_ROTOM_WASH,
...
static const struct TrainerMonItemCustomMoves sParty_Harrison[] = {
    ...
    .species = SPECIES_BLISSEY,
    .spread = SPREAD_31_IV_80_EV,
    .moves = MOVE_WATER_PULSE, MOVE_ICE_BEAM, MOVE_THUNDERBOLT, MOVE_BODY_SLAM
    },
    {
    .lvl = -2,
    .species = SPECIES_OMASTAR,
...
static const struct TrainerMonItemCustomMoves sParty_Tisha[] = {
    ...
    .species = SPECIES_FLORGES,
    .spread = SPREAD_31_IV_80_EV,
    .moves = MOVE_ENERGY_BALL, MOVE_MOONBLAST, MOVE_LEECH_SEED, MOVE_PROTECT
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Kiyo[] = {
    ...
    .species = SPECIES_TOXICROAK,
    .spread = SPREAD_31_IV_80_EV,
    .moves = MOVE_SUCKER_PUNCH, MOVE_DRAIN_PUNCH, MOVE_BULK_UP, MOVE_POISON_JAB
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_TateAndLiza1[] = { // Inverse Battle!
    ...
    .heldItem = ITEM_LEFTOVERS,
    .spread = SPREAD_31_IV_HP_SPATK_QUIET,
    .moves = MOVE_SURF, MOVE_PSYCHIC, MOVE_ICE_BEAM, MOVE_TRICK_ROOM
    },
    {
    .lvl = 2,
    .species = SPECIES_LUNATONE,
    ...
    .ability = 1, // Magic Guard
    .spread = SPREAD_31_IV_HP_SPATK_QUIET,
    .moves = MOVE_PSYCHIC, MOVE_AURA_SPHERE, MOVE_THUNDER, MOVE_TRICK_ROOM
    },
    {
    .lvl = 0,
    .species = SPECIES_CLAYDOL,
...
static const struct TrainerMonItemCustomMoves sParty_Juan1[] = {
    ...
    .ability = 0, // Intimidate
    .spread = SPREAD_31_IV_ATK_SPEED_ADAMANT,
    .moves = MOVE_WATERFALL, MOVE_STONE_EDGE, MOVE_POWER_WHIP, MOVE_DRAGON_DANCE
    },
    {
    .lvl = 1,
    .species = SPECIES_SWAMPERT,
    ...
    .ability = 2, // Hydration
    .spread = SPREAD_31_IV_HP_SPATK_MODEST,
    .moves = MOVE_HYDRO_PUMP, MOVE_FREEZE_DRY, MOVE_THUNDER, MOVE_REST
    },
    {
    .lvl = 1,
    .species = SPECIES_BLASTOISE,
    ...
    .ability = 1, // Mega Launcher
    .spread = SPREAD_31_IV_HP_SPATK_MODEST,
    .moves = MOVE_WATER_PULSE, MOVE_FLASH_CANNON, MOVE_ICE_BEAM, MOVE_AURA_SPHERE
    },
    {
    .lvl = 2,
    .species = SPECIES_KINGDRA,
    ...
    .ability = 0, // Swift Swim
    .spread = SPREAD_31_IV_SPATK_SPEED_MODEST,
    .moves = MOVE_HYDRO_PUMP, MOVE_HURRICANE, MOVE_DRACO_METEOR, MOVE_FOCUS_ENERGY  
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Nicolas3[] = {
    ...
    .heldItem = ITEM_LEFTOVERS,
    .spread = SPREAD_31_IV_HP_SPATK_MODEST,
    .moves = MOVE_DAZZLING_GLEAM, MOVE_FIRE_BLAST, MOVE_COTTON_GUARD, MOVE_ROOST
    },
    {
    .lvl = 0,
    .species = SPECIES_HYDREIGON,
...
static const struct TrainerMonItemCustomMoves sParty_Halle[] = { // with Mitchell
    ...
    .ability = 0, // Own Tempo
    .spread = SPREAD_31_IV_HP_SPATK_MODEST,
    .moves = MOVE_BODY_SLAM, MOVE_FIRE_BLAST, MOVE_THUNDER, MOVE_ICE_BEAM
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Sidney[] = { //Singles
    ...
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_STONE_EDGE, MOVE_CRUNCH, MOVE_ICE_PUNCH, MOVE_FIRE_PUNCH
    },
    {
    .lvl = 1,
    .species = SPECIES_EXCADRILL,
    ...
    .ability = 0, // Sand Rush
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_IRON_HEAD, MOVE_KNOCK_OFF, MOVE_X_SCISSOR, MOVE_DRILL_RUN
    },
    {
    .lvl = 1,
    .species = SPECIES_CACTURNE,
    ...
    .ability = 2, // Prankster
    .spread = SPREAD_31_IV_ATK_SPEED_ADAMANT,
    .moves = MOVE_SUCKER_PUNCH, MOVE_BRAVE_BIRD, MOVE_TAILWIND, MOVE_THUNDER_WAVE
    },
    {
    .lvl = 2,
    .species = SPECIES_HYDREIGON,
...
static const struct TrainerMonItemCustomMoves sParty_Phoebe[] = { //Singles
    ...
    .ability = 2, // Rock Head
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_FLARE_BLITZ, MOVE_STONE_EDGE, MOVE_SHADOW_BONE, MOVE_BONEMERANG
    },
    {
    .lvl = 1,
    .species = SPECIES_GENGAR,
    ...
    .ability = 0, // Levitate
    .spread = SPREAD_31_IV_SPATK_SPEED_MODEST,
    .moves = MOVE_SHADOW_BALL, MOVE_SLUDGE_BOMB, MOVE_GIGA_DRAIN, MOVE_DAZZLING_GLEAM
    },
    {
    .lvl = 1,
    .species = SPECIES_GOLURK,
    ...
    .ability = 2, // No Guard
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_SHADOW_PUNCH, MOVE_STONE_EDGE, MOVE_EARTHQUAKE, MOVE_DYNAMIC_PUNCH
    },
    {
    .lvl = 1,
    .species = SPECIES_CROBAT,
    .heldItem = ITEM_FIRE_GEM,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_TAILWIND, MOVE_BRAVE_BIRD, MOVE_CROSS_POISON, MOVE_HEAT_WAVE
    },
    {
    .lvl = 2,
    .species = SPECIES_MISMAGIUS,
    ...
    .ability = 2, // Pixilate
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_SHADOW_BALL, MOVE_HYPER_VOICE, MOVE_MYSTICAL_FIRE, MOVE_DAZZLING_GLEAM
    },
};

static const struct TrainerMonItemCustomMoves sParty_Glacia[] = { //Singles
    {
    .lvl = 1,
    .species = SPECIES_NINETALES_ALOLAN,
    .heldItem = ITEM_CHOICE_SCARF,
    .ability = 2, // Snow Warning
    .spread = SPREAD_31_IV_HP_SPATK_MODEST,
    .moves = MOVE_BLIZZARD, MOVE_DAZZLING_GLEAM, MOVE_PSYSHOCK, MOVE_AURORA_VEIL
    },
    {
    .lvl = 1,
    .species = SPECIES_SANDSLASH_ALOLAN,
    ...
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_HIGH_HORSEPOWER, MOVE_ICICLE_CRASH, MOVE_IRON_HEAD, MOVE_ICE_SHARD
    },
    {
    .lvl = 2,
    .species = SPECIES_WALREIN,
    ...
    .ability = 1, // Ice Body
    .spread = SPREAD_31_IV_HP_DEF_BOLD,
    .moves = MOVE_TOXIC, MOVE_PROTECT, MOVE_LIQUIDATION, MOVE_AVALANCHE
    },
    {
    .lvl = 1,
    .species = SPECIES_GLACEON,
    ...
    .ability = 2, // Slush Rush
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_BLIZZARD, MOVE_FLAMETHROWER, MOVE_THUNDERBOLT, MOVE_PSYCHIC
    },
    {
    .lvl = 1,
    .species = SPECIES_FROSLASS,
...
static const struct TrainerMonItemCustomMoves sParty_Drake[] = { //singles
    {
    .lvl = 1,
    .species = SPECIES_STEELIX,
    .heldItem = ITEM_LEFTOVERS,
    .ability = 2, // Adaptability
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_EARTHQUAKE, MOVE_IRON_TAIL, MOVE_ROCK_SLIDE, MOVE_BODY_PRESS
    },
    {
    .lvl = 2,
    .species = SPECIES_SALAMENCE,
    ...
    .ability = 2, // Rough Skin
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_OUTRAGE, MOVE_HIGH_HORSEPOWER, MOVE_STRENGTH, MOVE_SWORDS_DANCE
    },
    {
    .lvl = 1,
    .species = SPECIES_KINGDRA,
    ...
    .ability = 2, // Adaptability
    .spread = SPREAD_31_IV_HP_SPATK_MODEST,
    .moves = MOVE_SLUDGE_WAVE, MOVE_DRACO_METEOR, MOVE_FOCUS_BLAST, MOVE_THUNDERBOLT
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Wallace[] = { //Singles
    ...
    .species = SPECIES_DUSKNOIR,
    .heldItem = ITEM_LIFE_ORB,
    .ability = 1, // Iron Fists
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_TRICK_ROOM, MOVE_SHADOW_SNEAK, MOVE_SHADOW_PUNCH, MOVE_DRAIN_PUNCH
    },
    {
    .lvl = 2,
    .species = SPECIES_SCIZOR,
    ...
    .ability = 0, // Prankster
    .spread = SPREAD_31_IV_HP_DEF_BOLD,
    .moves = MOVE_FOUL_PLAY, MOVE_THUNDER_WAVE, MOVE_LIGHT_SCREEN, MOVE_REFLECT
    },
    {
    .lvl = 3,
    .species = SPECIES_FLYGON,
    .heldItem = ITEM_LIFE_ORB,
    .ability = 1, // Levitate -> Sand Song
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_BOOMBURST, MOVE_DRAGON_PULSE, MOVE_BUG_BUZZ, MOVE_HEAT_WAVE
    }
};
